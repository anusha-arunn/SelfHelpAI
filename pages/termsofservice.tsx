    ...
    <>
      ...
      <div className="py-10 flex justify-center items-center">
        <div className={roboto.className}>
          <div className="text-center py-7 text-3xl">Terms of Service</div>
          <div className="text-justify text-l">
            Welcome to AI Therapist. Please read the following terms carefully
            as they govern your use of our platform.
            <br />
            <br />
            <ul>
              1. Use of Platform: By accessing and using our platform, you agree
              to be bound by these terms of service. You also acknowledge that
              you have read and understand our privacy policy.
            </ul>
            <ul>
              2. Personal Information: Our platform collects personal
              information to provide personalized support and guidance. We take
              privacy seriously and will never share or sell your information to
              third parties.
            </ul>
            <ul>
              ...
              guidance. While our platform can provide helpful guidance, it
            ...
            <ul>
              ...
              damages arising from your use of our platform. You agree to use
              our platform at your own risk.
            </ul>
            <ul>
              8. Governing Law: These terms of service are governed by the laws
              ...
              and your continued use of our platform constitutes acceptance of
              any changes.
            </ul>
          </div>
        </div>
